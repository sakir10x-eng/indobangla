...
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "rm -rf /var/www/indobangla-laravel/shop.zip /var/www/indobangla-laravel/shop";`
...
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "unzip /var/www/indobangla-laravel/shop.zip -d /var/www/indobangla-laravel";`

echo('Install Node For shop')
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "yarn --cwd /var/www/indobangla-laravel/shop";`
