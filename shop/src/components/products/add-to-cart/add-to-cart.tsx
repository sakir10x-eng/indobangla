...
export const AddToCart = ({
  ...
  const handleAddClick = async (
    ...
    // Every card, bundle strip and wishlist row funnels through here. During a challenge
    // run none of them are a legal source — books have to be found on their own page.
    const ok = await guardAdd('list', data?.id);
    if (!ok) return;
