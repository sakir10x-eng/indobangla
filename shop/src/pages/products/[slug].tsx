...
const RelatedBooks = dynamic(
  () => import('@/components/products/details/related-books')
);
    ...
    <>
      ...
      <AttributesProvider>
        <div className="min-h-screen bg-light">
          ...
          {/* Related books first; reviews + Q&A pushed to the very end */}
          {product.type?.slug === 'books' && (
            <RelatedBooks productId={product?.id} authorName={product?.author?.name} />
          )}
          ...
          <ProductQuestions
            ...
            productType={product?.type?.slug}
          />
          {/* room so the mobile sticky buy-bar never overlaps the last section */}
          {product.type?.slug === 'books' && (
