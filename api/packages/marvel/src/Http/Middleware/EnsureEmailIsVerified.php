...
class EnsureEmailIsVerified
{
    ...
    public function handle($request, Closure $next, $redirectToRoute = null)
    {
        ...
        /** 
         * making useLocalLicense default value to `true` for demo and qa purpose 
         * Reason: In the live configuration, multiple pods are deployed to handle concurrency, and different storage solutions are utilized. 
         * This setup has the potential to introduce data inconsistency issues
         */
        $useLocalLicense = isset($localLicense['trust']) ? $localLicense['trust'] : true; 
