    ...
    public function run()
    {
        DB::table('terms_and_conditions')->insert([
            [
                ...
                "description" => 'The Website is provided "as is" and "as available" without any warranties, either expressed or implied. Indobangla shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages resulting from the use or inability to use the Website.',
                "type" => "global",
