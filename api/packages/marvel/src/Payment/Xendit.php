...
use Xendit\Configuration as XenditFacade;
...
class Xendit extends Base implements PaymentInterface
{
  ...
  public function __construct()
  {
    ...
    $this->xenditClient->setXenditKey(config('shop.xendit.api_key'));
  ...
  public function getIntent($data): array
  {
    try {
      ...
      $order = $this->invoiceApi->createInvoice(new CreateInvoiceRequest($params));
  ...
  {
    try {
      $result = $this->invoiceApi->getInvoiceById($paymentId);
