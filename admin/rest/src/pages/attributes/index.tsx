...
import { useAttributesPaginatedQuery } from '@/data/attributes';
...
export default function AttributePage() {
  ...
  const { attributes, loading, error, paginatorInfo } =
    useAttributesPaginatedQuery({
      orderBy,
      sortedBy,
      language: locale,
      limit: 20,
      page,
      request_for: 'pagination_list',
    });
