import { AuthorUpdateCell } from '@/components/author/update-cell';
...
import { Attachment, Author, MappedPaginatorInfo, SortOrder } from '@/types';
...
const AuthorList = ({
  ...
  let columns = [
    ...
    },
    {
      ...
      align: 'center' as AlignType,
      width: 160,
      render: (is_approved: boolean, record: Author) => (
        <AuthorUpdateCell is_approved={is_approved} record={record} />
      ),
    },
    {
