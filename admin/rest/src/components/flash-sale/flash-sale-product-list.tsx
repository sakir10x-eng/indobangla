...
import { OfferPriceSale } from '@/components/flash-sale/offer-price-cell';
  ...
  let columns = [
        ...
        return (
          <span className="whitespace-nowrap">
            {record?.product_type === ProductType.Variable ? (
              <>
                <PriceCell price={record?.min_price!} />
                {record?.min_price && record?.max_price ? ' - ' : ''}
                <PriceCell price={record?.max_price!} />
              </>
            ) : (
    ...
    // },
    {
      ...
      render: (value: number, record: Product) => (
        <OfferPriceSale type={type!} rate={rate!} record={record} />
      ),
    },
    {
