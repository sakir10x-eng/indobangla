  ...
  const columns = [
      ...
      render: function Render(paid_total: number) {
        ...
        return (
          <span className="whitespace-nowrap">
            <PriceCell price={paid_total_amount} />
          </span>
        );
      },
    },
    {
      ...
      render: function Render(amount: number) {
        const total_amount = amount ? amount : 0;
        return <PriceCell price={total_amount} />;
      },
    },
    {
      ...
      render: function Render(value: number) {
        ...
        return <PriceCell price={delivery_fee} />;
      },
    },
    {
      ...
      render: function Render(sales_tax: number) {
        ...
        return <PriceCell price={sales_tax_amount} />;
      },
    },
    {
      ...
      render: function Render(discount: number) {
        const sales_discount_amount = discount ? discount : 0;
        return <PriceCell price={sales_discount_amount} />;
      },
    },
    {
