...
export const useResendVerificationEmail = () => {
  ...
  return useMutation(userClient.resendVerificationEmail, {
    onSuccess: () => {
      toast.success(t('common:INDOBANGLA_MESSAGE.EMAIL_SENT_SUCCESSFUL'));
    },
    onError: () => {
      toast(t('common:INDOBANGLA_MESSAGE.EMAIL_SENT_FAILED'));
    },
  });
};
...
export const useLicenseKeyMutation = () => {
  ...
  return useMutation(userClient.addLicenseKey, {
    ...
    onError: () => {
      toast.error(t('common:INDOBANGLA_MESSAGE.INVALID_LICENSE_KEY'));
    },
  });
};
