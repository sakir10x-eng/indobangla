...
import {
  ...
  CUSTOMER_REFUND_POLICY_PRAMS,
  FAQ_AND_HELPS_PRAMS,
  FLASH_SELL_PRAMS,
  MANUFACTURERS_AND_PUBLISHERS_PRAMS,
  PRIVACY_POLITY_PRAMS,
  TERMS_AND_CONDITIONS_PRAMS,
  VENDOR_REFUND_POLICY_PRAMS,
...
export const siteSettings = {
  ...
  author: {
    name: 'IndoBangla',
    websiteUrl: 'https://indobangla.com',
    address: '',
  },
  headerLinks: [],
  authorizedLinks: [
        ...
        childMenu: [
          {
            ...
            childMenu: [
              ...
              {
                href: Routes?.integrationsSettings,
                label: 'Couriers & Payments',
                icon: 'SettingsIcon',
              },
              {
              ...
              {
                href: '/settings/preorder',
                label: 'Pre-order Pricing',
                icon: 'SettingsIcon',
              },
              {
                href: '/settings/challenge',
                label: '⏱️ 1-Minute Challenge',
                icon: 'SettingsIcon',
              },
              {
                href: '/settings/readers-club',
                label: "Readers' Club",
                icon: 'SettingsIcon',
              },
              {
