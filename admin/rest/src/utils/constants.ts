...
export const CHECKOUT = 'indobangla-checkout';
...
export const MAXIMUM_WORD_COUNT_FOR_RICH_TEXT_EDITOR_SMALL: number = 1000;
...
export const TERMS_AND_CONDITIONS_PRAMS = 'terms';
export const PRIVACY_POLITY_PRAMS = 'privacy';
export const BECOME_A_SELLER_PRAMS = 'become-a-seller';
export const FLASH_SELL_PRAMS = 'flash-sale';
export const MANUFACTURERS_AND_PUBLISHERS_PRAMS = 'manufacturers';
export const AUTHORS_PRAMS = 'authors';
export const FAQ_AND_HELPS_PRAMS = 'help';
export const CUSTOMER_REFUND_POLICY_PRAMS = 'customer-refund-policies';
export const VENDOR_REFUND_POLICY_PRAMS = 'vendor-refund-policies';
